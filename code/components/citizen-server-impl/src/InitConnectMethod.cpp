...
static InitFunction initFunction([]()
{
	fx::ServerInstanceBase::OnServerCreate.Connect([](fx::ServerInstanceBase* instance)
	{
		...
		auto lanVar = instance->AddVariable<bool>("sv_lan", ConVar_ServerInfo, true);//def	auto lanVar = instance->AddVariable<bool>("sv_lan", ConVar_ServerInfo, false) no need to add "sv_lan 1" in server.cfg(lazy fix).
...
>>>>>>> aad85aa7c306015921657ef71b07aa3da6172183
